  ...
  return (
    ...
    >
      ...
      <div className="hero-content flex flex-col text-center text-neutral-content">
        ...
        <div>
          <input className="md:py-2 md:pr-24 md:pl-3 pl-3 " type="text"  placeholder="Search here...." />
          <button className="bg-[#FF444A] text-white md:px-6 md:py-2 px-2 rounded-r-md md:rounded-r-lg" >Search </button>
        </div>
        </div>
